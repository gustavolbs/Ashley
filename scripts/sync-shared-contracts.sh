...
for persona in "${PERSONAS[@]}"; do
  ...
  for pair in     "anti-slop.md:docs/ANTI_SLOP.md"     "execution-modes.md:docs/EXECUTION_MODES.md"     "model-routing.md:docs/MODEL_ROUTING.md"     "mutation-authority.md:docs/MUTATION_AUTHORITY.md"     "project-context.md:docs/PROJECT_CONTEXT.md"
  do
  ...
  if (( check )); then
    ...
    cp "$ROOT/scripts/project-context.py" "$target"; chmod +x "$target"
  fi
done
