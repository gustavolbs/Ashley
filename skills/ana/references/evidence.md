...
## Ana-specific measurement rule

A campaign being live is not proof of growth. Validate tracking integrity before interpreting performance.

Platform-reported conversions/ROAS are not sufficient when first-party events, attribution, consent or data quality are known to be broken.
