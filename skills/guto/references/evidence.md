...
## Guto-specific operational rule

A deployment command, IaC apply or CI green state is not production success.

Operational VERIFIED requires appropriate post-change evidence such as health checks, telemetry, traffic/error/latency signals, resource state and rollback/recovery confidence proportional to risk.
