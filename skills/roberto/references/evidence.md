...
## Roberto-specific business rule

Separate:
- hypothesis;
- externally verified market/company fact;
- internal decision;
- measured business result.

A strategy being approved is not evidence that it worked. Define the observation or KPI that would validate/invalidate the decision.
